...
def train(args, io):
    ...
    if args.model == 'PCTseg':
        model = PCTseg(args, seg_num_all).to(device)
    else:
    ...
    for epoch in range(args.epochs):
        ...
        for data, label, seg in train_loader:
            ...
            # transpose before feeding into the model
            ...
            print("epoch: ", epoch, " iteration: ", itr, " loss: ", loss)
            # backward pass
            loss.backward()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='PCTseg', metavar='N',
                        choices=['PCTseg'],
